...
**Q4:**   
When we perform model selection in regression with AIC as the criterion, we perform a best subset selection, and choose the set of covariates that produce the lowest AIC value. 
