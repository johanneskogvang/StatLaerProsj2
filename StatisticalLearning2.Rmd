...
library(e1071)
set.seed(2)
CV_radial = tune(svm, diabetes ~ ., data=sctrain, kernel="radial", ranges=list(gamma=c(10^-5, 10^-4,0.001,0.01,0.1,1,2,3,4,5), cost=c(0.001, 0.01, 0.1, 1, 5, 10, 20,40,80,100,120,140,160)))
#summary(CV_radial)
