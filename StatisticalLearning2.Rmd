...
#Finding the misclassification rate for the training set:
svm_train_prob=predict(svm_best_model, newdata=ctrain, type="response")
svm_train_pred=ifelse(svm_train_prob>0.5, 1, 0)
conf_train_svm=table(svm_train_pred, ctrain$diabetes) #Her skjer det noe feil????
conf_train_svm
misclass_train_svm=(300-sum(diag(conf_train_svm)))/300
print("Misclassification rate for the train set: ")
misclass_train_svm
