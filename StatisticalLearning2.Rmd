...
We choose to use bagging on a classification tree to analyse the data. 
...
kan lage det oversiktstreet= variable importance plot that show the relative importance of each predictor. this means that the predictors are sorted based on their importance. Therefor the more important predictors are placed further up in the tree than the less important ones. 
...
par(pty='s')
bagging_ROC = roc(ctest[ ,1], diab.bag_prob, plot=TRUE, legacy.axces=TRUE)
bagging_ROC
