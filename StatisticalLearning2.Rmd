...
```
In the variance importance plot we see that `glu` is the most important covariate both when it comes to 

kan noen hjelpe meg å forstå variable importance plots?
jeg tror at de som er lengst opp er viktigst, men jeg skjønner ikke så mye mer. 
